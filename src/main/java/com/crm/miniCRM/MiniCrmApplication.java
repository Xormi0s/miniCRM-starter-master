...
//PersonAddress
    ...
    private static void extractPersonAddresses(PersonAddressRepository personAddressRepository) {
        personAddressRepository.save(new PersonAddress(new PersonAddressID(1L, 1L), "a@b.com", "12343456", "34567789", 'P',"email"));
        personAddressRepository.save(new PersonAddress(new PersonAddressID(2L, 1L), "b@c.com", "23434567", "34567789", 'P',"brief"));
        personAddressRepository.save(new PersonAddress(new PersonAddressID(3L, 2L), "d@e.com", "34345678", "34567789", 'P',"alles"));
        personAddressRepository.save(new PersonAddress(new PersonAddressID(4L, 3L), "f@g.com", "43456789", "34567789", 'P',"telefonisch"));
    ...
    private static void extractEvents(EventRepository eventRepository) {
        eventRepository.save(new Event(new CommunityID((long) 1),"kerstkaartjes 2020", LocalDate.of(2020, 12, 16), LocalTime.of(8,30)));
        eventRepository.save(new Event(new CommunityID((long) 2),"BBQ 2020", LocalDate.of(2020, 7, 21), LocalTime.of(16,45)));
        eventRepository.save(new Event(new CommunityID((long) 3),"doopfeest 2021", LocalDate.of(2021, 5, 31),LocalTime.of(14,15)));
        // fetch all Persons
    ...
    private static void extractCommunities(CommunityRepository communityRepository) {
        ...
        communityRepository.save(new Community("Kerstfeest"));
        // fetch all Persons
